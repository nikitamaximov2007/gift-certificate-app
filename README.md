...
АРМ специалиста салона красоты - программа для создания персонализированных подарочных сертификатов.

Администратор вводит имя клиента, сумму и выбирает сезонное оформление. Программа генерирует готовый PNG-файл высокого разрешения (4096x2304 px), который можно распечатать или отправить клиенту.
